...
### file names. These are noted in the script on lines 28, 29 and 31.
...
pm_files$file <- gsub("chunk_", "", pm_files$file) # adjust regex to fit your file names
pm_files$file <- gsub("passage_", "", pm_files$file) # adjust regex to fit your file names
pm_files %>% 
